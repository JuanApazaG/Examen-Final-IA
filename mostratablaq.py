...
# Mostrar un estado específico (por ejemplo, estado (5, 5, 5, 5))
estado_fijo = (5, 5, 5, 5)  # Ejemplo de un estado específico
print(f"\nValores Q para el estado fijo {estado_fijo}:")
print(data[estado_fijo])
